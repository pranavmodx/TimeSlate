function add(idName) {
    ...
    let hTag = document.querySelector(`#${idName}`);
    // console.log(`hTag : ${hTag}`);
    // console.log(`hTag innerHTML before : ${hTag.innerHTML}`);
    ...
    hTag.textContent = (hours ? (hours > 9 ? hours : "0" + hours) : "00") + ":" + (minutes ? (minutes > 9 ? minutes : "0" + minutes) : "00") + ":" + (seconds > 9 ? seconds : "0" + seconds);
